...
ARCH_MODE="${2:-host}"
APP_NAME="CapMind"
BUNDLE_ID="io.lardissone.capmind"
...
if [[ -f "$ICON_SRC" ]]; then
    ...
    echo "    note: no Resources/AppIcon.icns found — building without a custom icon."
    ICON_PLIST_ENTRIES=""
fi
...
$ICON_PLIST_ENTRIES
    ...
    <true/>
    <key>SUFeedURL</key>
    <string>https://lardissone.github.io/cap-mind/appcast.xml</string>
